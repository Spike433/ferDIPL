...
public class defs {
    ...
    public static final int MSQ = 5;
    /* unspecified multi-server queue */

    // Queueing disciplines
    public static final int ISRV = 6;
    /* infinite server */
    public static final int FCFS = 7;
    /* first-come first-serve */
    public static final int PSHR = 8;
    /* processor sharing */
    public static final int LCFS = 9;
    ...
    // MP scalability
    public static final int PDQ_SP = 18;
    /* uniprocessor */
    public static final int PDQ_MP = 19;
    /* multiprocessor */
