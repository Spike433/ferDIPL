...
public class PDQ {
    ...
    //---------------------------------------------------------------------
    /**
     * generates a formatted report containing system, and node level
    ...
    //---------------------------------------------------------------------
    /**
     * defines the characteristics of a workload in a closed - circuit queueing
     * model.
     */
    ...
    //---------------------------------------------------------------------
    /**
     * Returns the utilization of the designated queueing node by the specified
     * workload.
     */
