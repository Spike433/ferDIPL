...
D=subs(D, [q2, q3, m1, m4], [0, pi/2, 0, 0]);
vpa(simplify(D), 6)
vpa(simplify(D(1, 1)), 6)
vpa(simplify(D(4, 4)), 6)
vpa(simplify(D(5, 5)), 6)

D=subs(D, [q2, q3, l1, l2, l3, l4, m1, m2, m3, m4, m5], [0, pi/2, 0.015, 0.105, 0.05595, 0.0575, 0, 0.015, 0.105, 0, 0.05595+0.0575]);
vpa(simplify(D), 6)
vpa(simplify(D(1, 1)), 6)
vpa(simplify(D(4, 4)), 6)
vpa(simplify(D(5, 5)), 6)
...
m4=0;
m5=0.05595+0.0575;
A1=subs(A1, [q2, q3, l1, l2, l3, l4, m1, m2, m3, m4, m5], [0, pi/2, 0.015, 0.105, 0.05595, 0.0575, 0, 0.015, 0.105, 0, 0.05595+0.0575]);
A2=subs(A2, [q2, q3, l1, l2, l3, l4, m1, m2, m3, m4, m5], [0, pi/2, 0.015, 0.105, 0.05595, 0.0575, 0, 0.015, 0.105, 0, 0.05595+0.0575]);
A3=subs(A3, [q2, q3, l1, l2, l3, l4, m1, m2, m3, m4, m5], [0, pi/2, 0.015, 0.105, 0.05595, 0.0575, 0, 0.015, 0.105, 0, 0.05595+0.0575]);
A4=subs(A4, [q2, q3, l1, l2, l3, l4, m1, m2, m3, m4, m5], [0, pi/2, 0.015, 0.105, 0.05595, 0.0575, 0, 0.015, 0.105, 0, 0.05595+0.0575]);
A5=subs(A5, [q2, q3, l1, l2, l3, l4, m1, m2, m3, m4, m5], [0, pi/2, 0.015, 0.105, 0.05595, 0.0575, 0, 0.015, 0.105, 0, 0.05595+0.0575]);
M1=vpa(-9.81*(m1*A1(2,1)+m2*A2(2,1)+m3*A3(2,1)+m4*A4(2,1)+m5*A5(2,1)),6)
M2=vpa(-9.81*(m1*A1(2,4)+m2*A2(2,4)+m3*A3(2,4)+m4*A4(2,4)+m5*A5(2,4)),6)
M3=vpa(-9.81*(m1*A1(2,5)+m2*A2(2,5)+m3*A3(2,5)+m4*A4(2,5)+m5*A5(2,5)),6)